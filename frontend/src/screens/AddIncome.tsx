...
import { Receita, parseDateFromInput, parseValorFromInput } from "@/domain/Transacao";
...
export default function AddIncome() {
  ...
  function handleSave() {
    try {
      ...
      const r = new Receita(
        idUsuario,
        1, // idConta removido do formulário (placeholder)
        categoriaId || 1,
        descricao,
        v,
        d1,
      ...
      // Apenas front: simulamos persistência local
    ...
    <View style={{ flex: 1 }}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.select({ ios: "padding", android: undefined })}>
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 32, gap: 12 }}>
          ...
          <HelperText type="info">Use ponto ou vírgula. Ex.: 1200,50</HelperText>
