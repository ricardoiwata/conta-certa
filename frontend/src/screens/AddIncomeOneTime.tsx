...
export default function AddIncomeOneTime() {
  ...
  async function handleSave() {
    try {
      ...
      setSnack("✓ Receita cadastrada com sucesso!");
      setTimeout(() => {
        router.back();
      }, 1500);
    } catch (e: any) {
      console.error("Erro ao salvar receita:", e);
      setError(e?.message || "Erro ao salvar a receita");
    }
  }
  ...
  return (
    <View style={{ flex: 1 }}>
      <Appbar.Header>
        ...
        <Appbar.Content title="Nova Receita (não recorrente)" />
      </Appbar.Header>
