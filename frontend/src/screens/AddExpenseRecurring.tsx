...
export default function AddExpenseRecurring() {
  ...
  const disableSubmit = useMemo(
    () => !descricao || !data || categoriaId == null,
    [descricao, data, categoriaId]
  );
  ...
  async function handleSave() {
    try {
      ...
      setSnack("Despesa recorrente cadastrada!");
  ...
  return (
    <View style={{ flex: 1 }}>
      <Appbar.Header>
        ...
        <Appbar.Content title="Nova Despesa (recorrente)" />
      </Appbar.Header>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.select({ ios: "padding", android: undefined })}>
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 32, gap: 12 }}>
          ...
          <HelperText type="info">Ex.: Aluguel, academia, assinatura</HelperText>
